...
public final class State {
    ...
    public void generateIniSolution(int i) {
        InitialSolution initialSolution = new InitialSolution(this);
        if (i == 0)
            initialSolution.iniSolution_0();
        // TODO
    }

    public void generateIniSolution(String filePath) {
        InitialSolution initialSolution = new InitialSolution(this);
        initialSolution.readIniSolution(filePath);
    }


    public  boolean canConnectSensor(int sensorIndex, Node dst) {
        if (dst == null)
            return true;
    ...
    public void connectSensor(int sensorIndex, Node dst) {
        Node src = sensors.get(sensorIndex);
